...
export interface ApiBranchBranch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DayOff: Schema.Attribute.RichText &
    ...
    > &
      Schema.Attribute.Private;
    MapImage: Schema.Attribute.Media<'images', true>;
    MapLink: Schema.Attribute.String;
    Messenger: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    sms_messages: Schema.Attribute.Relation<
      'manyToMany',
      'api::sms-message.sms-message'
    >;
    ...
    >;
    Voucher: Schema.Attribute.Relation<'manyToMany', 'api::voucher.voucher'>;
    WorkingTime: Schema.Attribute.String;
    Zalo: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String & Schema.Attribute.Required;
    ParentPath: Schema.Attribute.String;
...
export interface ApiConfigurationConfiguration extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    RegisterMessage: Schema.Attribute.Text;
    ReRegisterMessage: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDeviceTokenDeviceToken extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Platform: Schema.Attribute.Enumeration<['ios', 'android', 'web', 'other']>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGeneralApiUserOtp extends Struct.CollectionTypeSchema {
  collectionName: 'user_otps';
  info: {
    description: 'OTP records for user registration and login';
    displayName: 'User OTP';
  ...
  attributes: {
    attempt: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::general-api.user-otp'
    > &
      Schema.Attribute.Private;
    phoneNumber: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    purpose: Schema.Attribute.Enumeration<
      ['register', 'login', 'reset_password', 'verify_phone']
    > &
      Schema.Attribute.Required &
...
export interface ApiLandingPageLandingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    CmsBlock: Schema.Attribute.DynamicZone<
      [
...
export interface ApiNewsNews extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    FeatureImage: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    IsNotification: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiNotificationNotification
  ...
  attributes: {
    ActiveDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    Branch: Schema.Attribute.Relation<'manyToMany', 'api::branch.branch'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Description: Schema.Attribute.RichText &
    ...
    > &
      Schema.Attribute.Private;
    ManualDateTime1: Schema.Attribute.DateTime;
    ManualDateTime2: Schema.Attribute.DateTime;
    ManualDateTime3: Schema.Attribute.DateTime;
    ManualDateTime4: Schema.Attribute.DateTime;
    ManualDateTime5: Schema.Attribute.DateTime;
    NextRunAt: Schema.Attribute.DateTime;
    ProcessingAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    RetryTime: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    RunCount: Schema.Attribute.Integer &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    Schedule: Schema.Attribute.Enumeration<
      ['Immediately', 'Hourly', 'Daily', 'Weekly', 'Monthly', 'Manually']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Immediately'>;
    SelectMonthDay: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 31;
          min: 1;
        ...
        number
      >;
    SelectTime: Schema.Attribute.Time;
    SelectWeekDay: Schema.Attribute.Enumeration<
      ['MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT', 'SUN']
    >;
    SendStatus: Schema.Attribute.Enumeration<
      ['waiting', 'hold', 'processing', 'done', 'error']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'waiting'>;
    SendTo: Schema.Attribute.Enumeration<['All', 'User', 'Branch']> &
      Schema.Attribute.Required &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Url: Schema.Attribute.UID<'Name'> & Schema.Attribute.Required;
  };
}

export interface ApiSmsMessageSmsMessage extends Struct.CollectionTypeSchema {
  collectionName: 'sms_messages';
  info: {
    displayName: 'SmsMessage';
    pluralName: 'sms-messages';
    singularName: 'sms-message';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiVoucherHistoryVoucherHistory
  ...
  info: {
    displayName: 'Voucher History';
    pluralName: 'voucher-histories';
    singularName: 'voucher-history';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    AppliedDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    IsSuccess: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiVoucherVoucher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ApplyFor: Schema.Attribute.Enumeration<['All', 'User', 'Branch']> &
      Schema.Attribute.Required;
    Branch: Schema.Attribute.Relation<'manyToMany', 'api::branch.branch'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    User: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    voucher_histories: Schema.Attribute.Relation<
      'oneToMany',
      'api::voucher-history.voucher-history'
    >;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    ExpiredFirstRegisterVoucher: Schema.Attribute.Date;
    FirstName: Schema.Attribute.String;
    IsFirstRegister: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    IsUseFirstRegisterVoucher: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    LastName: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    MarkDelete: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    MarkDeleteDate: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::general-api.user-otp': ApiGeneralApiUserOtp;
